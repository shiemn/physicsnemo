...
#measure runtime
start=$(date +%s.%N)
mkdir -p /scratch/Norway/HCLIM3/preprocessed/


cp -n -r /anvme/workspace/b214cb13-ecodata/downscaling/Norway/HCLIM3/preprocessed/NorCP_AROME_EC-EARTH /scratch/Norway/HCLIM3/preprocessed/NorCP_AROME_EC-EARTH &
